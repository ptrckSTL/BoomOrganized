...
fun SheetValueFilterScreen(
    ...
    LazyColumn {
        ...
        itemsIndexed(filterViewState.values) { index, item ->
            FilterableCell(
                value = item,
                addToInclude = { addToInclude(index, item.value) },
                addToExclude = { addToExclude(index, item.value) }
            )
        }
    }
}
...
fun FilterableCell(
    ...
    Row(
        ...
        Icon(
            ...
            modifier = Modifier
                .size(24.dp)
                .clickable { addToInclude(value.value) }
        )
        Text(
            text = value.value,
        ...
        Icon(
            ...
            modifier = Modifier
                .size(24.dp)
                .clickable { addToExclude(value.value) }
        )
    }
}
